...
<div class="space-y-6" x-data="{
    ...
    <div class="bg-white p-4 lg:p-5 rounded-xl shadow-sm border border-gray-100 mb-6 space-y-4">
        ...
        <div class="flex justify-between items-center sm:justify-end">
            <button x-on:click="$dispatch('open-modal', 'tambah-tipe-modal')" class="w-full sm:w-auto px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md shadow-sm hover:bg-blue-700 transition-all flex items-center justify-center gap-2">
