...
<div class="space-y-6" x-data="{
    ...
    <div class="bg-white p-4 lg:p-5 rounded-xl shadow-sm border border-gray-100 mb-6 space-y-4">
        ...
        <div class="flex justify-between items-center sm:justify-end">
            <button x-on:click="$dispatch('open-modal', 'tambah-kapal-modal')" class="w-full sm:w-auto px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md shadow-sm hover:bg-blue-700 transition-all flex items-center justify-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                Tambah Kapal
            </button>
        </div>

        <form id="filter-form" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-3 relative z-50">
            <div class="w-full">
            ...
            <div class="w-full relative z-50">
                <select name="jenis_kapal_id" id="jenis-filter" class="searchable-select w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 outline-none">
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
                        <div class="flex flex-col">
                            ...
                            <span class="text-xs text-gray-500">Aktifkan untuk menampilkan data kapal ini</span>
                        </div>
