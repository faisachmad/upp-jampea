<x-app-layout>
    <x-slot name="title">Edit Kapal</x-slot>
    ...
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Edit Kapal: {{ $kapal->nama }}</h2>

        <!-- Form -->
        <form action="{{ route('master.kapal.update', $kapal) }}" method="POST" class="bg-white rounded-lg shadow p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text"
                           name="tanda_selar"
                           id="tanda_selar"
                           value="{{ old('tanda_selar', $kapal->tanda_selar) }}"
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200">
                </div>
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           id="tempat_kedudukan"
                           value="{{ old('tempat_kedudukan', $kapal->tempat_kedudukan) }}"
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text"
                           name="pemilik_agen"
                           id="pemilik_agen"
                           value="{{ old('pemilik_agen', $kapal->pemilik_agen) }}"
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200">
                </div>
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
                        ...
                        <label class="toggle-switch">
                            <input type="checkbox"
                                   name="is_active"
                                   value="1"
                                   {{ old('is_active', $kapal->is_active) ? 'checked' : '' }}>
